...
- [2026-07-07](incidents/2026-07-07.md) Remote users disappear when teleporting back to Genesis Plaza from a World
...
- [2026-09-12](vulnerabilities/2026-09-12-2.md) Ordinary scene JavaScript reached arbitrary native memory through a stale V8 WasmGC tag check in Godot Explorer
- [2026-09-12](vulnerabilities/2026-09-12.md) Production Mobile Hub bundled a whitelisted test key accepted for backoffice administration
